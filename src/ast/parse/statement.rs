        ...
        + 'a,
{
    spanned(preceded(
        ...
        map(
            ...
            |(e, b, else_b)| Statement::If(e, b, else_b),
        ),
    ))
}
            ...
            ws(alt((
                ...
                terminated(
                    spanned(map(
                        ...
                        |(name, typ)| Statement::Declare(name.map(|a| a.0.into()), typ),
                    )),
                    char('ඞ'),
                )
                ...
                terminated(
                    spanned(map(
                        ...
                        |(name, typ)| Statement::Define(name.map(|a| a.0.into()), typ),
                    )),
                    char('ඞ'),
                )
                .context(Context::Define),
                terminated(spanned(map(parse_expr, Statement::Expr)), char('ඞ')),
            ))),
        )
